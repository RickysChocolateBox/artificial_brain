import numpy as np
from rbm import RBM  # Assuming you have an implementation of the Restricted Boltzmann Machine (RBM)
...
class DBN:
    ...
    def build_rbms(self):
        ...
        for i in range(len(self.layers) - 1):
            rbm_layers.append(RBM(n_visible=self.layers[i], n_hidden=self.layers[i + 1]))
        return rbm_layers
