...
class InhibitoryInterneuronGainControl:
    def __init__(self, num_neurons, initial_connectivity=None, gain_control_factor=0.5, min_strength=-1, max_strength=0):
        self.num_neurons = num_neurons
        self.gain_control_factor = gain_control_factor
    ...
    def apply_gain_control(self, activity_levels):
        ...
        gain_control = np.sum(total_inhibition, axis=0) * self.gain_control_factor
        activity_levels /= (1 + gain_control)
