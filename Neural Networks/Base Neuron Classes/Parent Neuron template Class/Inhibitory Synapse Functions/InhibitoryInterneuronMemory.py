...
class InhibitoryInterneuronMemory:
    def __init__(self, num_neurons, initial_connectivity=None, decay_rate=0.1, min_strength=-1, max_strength=0):
    ...
    def apply_memory(self, activity_levels):
        ...
        self.connectivity *= (1 - self.decay_rate)
