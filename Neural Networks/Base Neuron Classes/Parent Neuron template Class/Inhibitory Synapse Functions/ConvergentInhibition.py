...
class ConvergentInhibition:
    ...
    def apply_convergent_inhibition(self, activity_levels):
        ...
        # Apply the convergent inhibition effect
        convergent_inhibition = np.sum(total_inhibition, axis=0) * self.inhibitory_strength

        # Modify the activity levels based on the convergent inhibition
        activity_levels -= convergent_inhibition
