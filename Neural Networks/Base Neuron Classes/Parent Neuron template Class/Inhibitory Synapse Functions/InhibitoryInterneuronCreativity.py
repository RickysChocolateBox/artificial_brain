...
class InhibitoryInterneuronCreativity:
    def __init__(self, num_neurons, inhibition_strength=0.5, creativity_threshold=0.6, learning_rate=0.01):
    ...
    def update_activity(self, activity_levels):
        high_activity_neurons = activity_levels >= self.creativity_threshold
    ...
    def creative_neurons(self, activity_levels):
        return np.argwhere(activity_levels >= self.creativity_threshold).flatten()
