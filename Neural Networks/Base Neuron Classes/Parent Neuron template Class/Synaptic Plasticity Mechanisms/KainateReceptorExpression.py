...
class KainateReceptorExpression:
    ...
    # Update kainate receptor expression
...
# This class represents the mechanism of changes in kainate receptor expression. The primary function, update_expression, updates the kainate receptor expression state based on the activity level and random noise. The expression state is increased or decreased according to the expression_rate depending on whether the activity level is above or below the expression_threshold.