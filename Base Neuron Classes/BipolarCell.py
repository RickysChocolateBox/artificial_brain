...
class :
    def __init__(self, activation_function=lambda x: x, learning_rate=0.01, refractory_period=2, firing_threshold=-55, resting_potential=-70, membrane_decay=0.9, sensory_input=0.0):
    ...
    def receive_sensory_input(self, sensory_input):
        self.sensory_input = sensory_input
        self.receive_signals([(self, sensory_input)])
