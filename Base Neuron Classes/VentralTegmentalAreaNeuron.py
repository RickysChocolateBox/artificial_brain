...
class VentralTegmentalAreaNeuron(NeuronBase):
    def __init__(self, neuron_id, firing_threshold, axon_length, dendritic_tree, synaptic_delay, refractory_period, dopamine_receptor_density, gaba_receptor_density, calcium_concentration, potassium_concentration, membrane_potential):
