...
class DivergentInhibition:
    ...
    def apply_divergent_inhibition(self, activity_levels):
        ...
        # Apply the divergent inhibition effect
        divergent_inhibition = np.sum(total_inhibition, axis=1) * self.inhibitory_strength

        # Modify the activity levels based on the divergent inhibition
        activity_levels -= divergent_inhibition
