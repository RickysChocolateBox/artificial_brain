...
class InhibitoryInterneuronSynapticScaling:
    def __init__(self, num_neurons, initial_connectivity=None, scaling_factor=0.1, min_strength=-1, max_strength=0):
    ...
    def update_synaptic_scaling(self, min_strength, max_strength):
        self.connectivity *= (1 + self.scaling_factor)
        self.connectivity = np.clip(self.connectivity, min_strength, max_strength)

    def apply_synaptic_scaling(self, activity_levels):
        self.update_synaptic_scaling(self.min_strength, self.max_strength)
