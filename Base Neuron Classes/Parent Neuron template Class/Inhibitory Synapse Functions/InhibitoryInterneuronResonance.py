...
class InhibitoryInterneuronResonance:
    def __init__(self, num_neurons, initial_connectivity=None, resonance_strength=0.5, min_strength=-1, max_strength=0):
    ...
    def apply_resonance(self, activity_levels, resonance_frequency):
        ...
        resonance = np.sin(2 * np.pi * resonance_frequency * np.sum(total_inhibition, axis=0)) * self.resonance_strength
        activity_levels += resonance
