...
class LateralConnectivitySuppression:
    def __init__(self, num_neurons, initial_connectivity=None, inhibitory_strength=0.5, suppression_radius=1, min_strength=-1, max_strength=0):
    ...
    def apply_lateral_connectivity_suppression(self, activity_levels):
        ...
        for i in range(self.num_neurons):
            for j in range(self.num_neurons):
                if abs(i - j) <= self.suppression_radius and i != j:
        ...
        # Apply the lateral connectivity suppression effect
