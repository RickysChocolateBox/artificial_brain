...
class ExternalTuftedCell(Neuron):
    ...
    def dendritic_branching(self):
        dendritic_branches = random.randint(2, 8) * self.dendritic_branching_factor
    ...
    def oscillatory_activity(self, input_data, frequency=40):
        oscillation = np.sin(2 * np.pi * frequency * input_data)
        return oscillation
